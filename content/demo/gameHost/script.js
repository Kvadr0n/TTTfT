...
var namePlayerOne_user = params.get('name_user');
var namePlayerTwo_user = "";
...
updateGame.onload = function()
{
	if (this.responseText != "NULL")
	{
		...
		this.open("GET", '/demo/infrastructure/HTTPhandler.php?name_game='+ params.get('name_game') + '&pass_game=' + params.get('pass_game') + '&request=updateGame&status=player1&namePlayerOne_user=' + namePlayerOne_user + '&namePlayerTwo_user=' + namePlayerTwo_user);
...
updateGame.open("GET", '/demo/infrastructure/HTTPhandler.php?name_game='+ params.get('name_game') + '&pass_game=' + params.get('pass_game') + '&request=updateGame&status=waiting');
updateGame.send();
...
{
	makeTurn.open("GET", '/demo/infrastructure/HTTPhandler.php?name_game='+ params.get('name_game') + '&pass_game=' + params.get('pass_game') + '&request=updateGame&status=turn1&x=' + x + '&y=' + y + '&namePlayerOne_user=' + namePlayerOne_user + '&namePlayerTwo_user=' + namePlayerTwo_user);
	makeTurn.send();
}