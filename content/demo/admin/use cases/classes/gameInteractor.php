<?php
require_once "/var/www/html/demo/admin/entities/classes/game.php";
				...
				for ($j = 0; $j < $height; ++$j)
				{
					...
					for ($i = 0; $i < $width; ++$i)
					{
						...
						switch ($num)
						{
							...
							case "1":
							{
								echo "<td><img src='/demo/infrastructure/HTTPhandler.php?request=getSkin&name={$query["name_skin1"]}&size=X'></td>";
								break;
							}
							case "2":
							{
								echo "<td><img src='/demo/infrastructure/HTTPhandler.php?request=getSkin&name={$query["name_skin2"]}&size=O'></td>";
								break;
							}
						}
					}
